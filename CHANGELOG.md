...
- 💄 **Styles**
  - **ErrorPage**: Suppression police serif sur le code ([#2348](https://github.com/assurance-maladie-digital/design-system/pull/2348))
...
- ⬆️ **Dépendances**
  ...
  - **netlify-cli:** Mise à jour vers la `v12.0.11` ([#2337](https://github.com/assurance-maladie-digital/design-system/pull/2337))
