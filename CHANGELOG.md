...
- 🐛 **Corrections de bugs**
  ...
  - **CookieBanner:** Correction des liens dans les exemples ([#2147](https://github.com/assurance-maladie-digital/design-system/pull/2147))
...
- ⬆️ **Dépendances**
  ...
  - **vuetify-loader:** Mise à jour vers la `v1.9.1` ([#2140](https://github.com/assurance-maladie-digital/design-system/pull/2140))
