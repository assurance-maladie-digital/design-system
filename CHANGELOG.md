...
- ✨ **Nouvelles fonctionnalités**
  - **FormBuilder:** Ajout de l'option formBuilder ([#636](https://github.com/assurance-maladie-digital/design-system/pull/636))
...
- ⬆️ **Dépendances**
  ...
  - **vue-router:** Mise à jour vers la `v3.4.7` ([#633](https://github.com/assurance-maladie-digital/design-system/pull/633))
