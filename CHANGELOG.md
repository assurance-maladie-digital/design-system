...
- 🔧 **Configuration**
  - **ci:** Mise à jour de `codecov` vers la `v3.0.0` ([#1365](https://github.com/assurance-maladie-digital/design-system/pull/1365))
...
- ⬆️ **Dépendances**
  ...
  - **core-js:** Mise à jour vers la `v3.17.1` ([#1402](https://github.com/assurance-maladie-digital/design-system/pull/1402)) ([6bd7131](https://github.com/assurance-maladie-digital/design-system/commit/6bd7131eb2a209c2d169388fd232ad7aab2c53c4))
