...
- ✨ **Nouvelles fonctionnalités**
  ...
  - **TableToolbar:** Ajout d'un nouveau composant ([#735](https://github.com/assurance-maladie-digital/design-system/pull/375))
...
- ⬆️ **Dépendances**
  ...
  - **copy-webpack-plugin:** Mise à jour vers la `v6.4.1` ([#797](https://github.com/assurance-maladie-digital/design-system/pull/797))
