...
Le module notification est utilisé avec le composant [`NotificationBar`](/composants/feedback/notification-bar) pour afficher des notifications aux utilisateurs.
