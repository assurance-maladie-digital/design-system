<template>
	<div>
		<VDivider class="w-100 mb-6"></VDivider>

		<VContainer class="mb-10 pa-0">
			<div v-for="item in componentList" :key="item.title">
				<h3 class="mt-8 mb-6">{{ item.title }}</h3>
				<VRow>
					<VCol
			...
			},
			{
				...
				components: [
					...
					},
					{
						...
						href: '/composants/feedback/accessibility-banner',
