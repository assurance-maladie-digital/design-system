			...
			<v-row>
				<v-col cols="12" sm="6" md="4">
					<nuxt-link to="../templates/cookies-page">
						<v-card class="fill-height" max-width="234">
							<doc-image src="templates/cookies-page.svg" width="234"></doc-image>
				...
				<v-col cols="12" sm="6" md="4">
					<nuxt-link to="../templates/error-page">
						<v-card class="fill-height" max-width="234">
							<doc-image src="templates/error-page.svg" width="234"></doc-image>
				...
				<v-col cols="12" sm="6" md="4">
					<nuxt-link to="../templates/notfound-page">
						<v-card class="fill-height" max-width="234">
							<doc-image src="templates/not-found-page.svg" width="234"></doc-image>
				...
				<v-col cols="12" sm="6" md="4">
					<nuxt-link to="../templates/maintenance-page">
						<v-card class="fill-height" max-width="234">
							<doc-image src="templates/maintenance-page.svg" width="234"></doc-image>
							<v-chip outlined color="green" x-small>Nouveau</v-chip>
