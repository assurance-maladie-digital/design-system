		...
		components: [
			{
				name: "HeaderBar",
				description:
					"Utilisé pour afficher l’en-tête d’une page ainsi qu’une barre de navigation.",
			...
			},
			{
				name: "SubHeader",
				description:
					"Utilisé pour afficher un bloc d’informations sous l’en-tête principale.",
			...
			},
			{
				name: "FooterWrapper",
				description:
					"Utilisé avec le composant FooterBtn pour afficher un pied de page.",
		...
		components: [
			{
				name: "PageContainer",
				description:
					"Conteneur transparent utilisé pour afficher une page.",
		...
		components: [
			{
				name: "ExternalLinks",
				description:
					"Utilisé pour afficher un menu avec une liste vers des liens externes.",
		...
		components: [
			{
				name: "BackBtn",
				description:
					"Utilisé pour permettre à l’utilisateur de revenir à la page précédente.",
			...
			},
			{
				name: "CopyBtn",
				description:
					"Utilisé pour afficher un bouton permettant à l’utilisateur de copier du texte.",
			...
			},
			{
				name: "LangBtn",
				description:
					"Utilisé pour permettre à l’utilisateur de choisir la langue de l’application",
			...
			},
			{
				name: "DownloadBtn",
				description:
					"Utilisé pour permettre à l’utilisateur de télécharger un document provenant d’une API.",
			...
			},
			{
				...
				description:
					"Utilisé pour afficher un bouton de connexion à FranceConnect.",
			...
			},
			{
				name: "UserMenuBtn",
				description:
					"Utilisé pour afficher un bouton activant un menu d’actions liées à l’utilisateur.",
		...
		components: [
			{
				name: "DatePicker",
				description:
					"Utilisé pour permettre à l’utilisateur de sélectionner ou de saisir une date.",
			...
			},
			{
				name: "PeriodField",
				description:
					"Utilisé pour permettre à l’utilisateur de saisir une période.",
			...
			},
			{
				name: "FileUpload",
				description:
					"Utilisé pour permettre à l’utilisateur de sélectionner ou de glisser-déposer des fichiers.",
			...
			},
			{
				name: "NirField",
				description:
					"Utilisé pour permettre à l’utilisateur de saisir un numéro de Sécurité sociale (NIR).",
			...
			},
			{
				name: "PhoneField",
				description:
					"Utilisé pour permettre à l’utilisateur de saisir un numéro de téléphone.",
			...
			},
			{
				name: "UploadWorkflow",
				description:
					"Utilisé pour permettre à l’utilisateur de sélectionner une liste de fichiers.",
		...
		components: [
			{
				name: "PaginatedTable",
				description:
					"Utilisé pour afficher une VDataTable de Vuetify avec une pagination persistante.",
			...
			},
			{
				name: "FilterModule",
				description:
					"Utilisé pour permettre à l’utilisateur de sélectionner des filtres.",
			...
			},
			{
				name: "TableToolbar",
				description:
					"Utilisé pour afficher une barre au-dessus des tableaux.",
		...
		components: [
			{
				name: "DialogBox",
				description:
					"Utilisé pour afficher une boîte de dialogue avec des boutons d’actions.",
			...
			},
			{
				...
				description:
					"Utilisé avec le module Vuex notification pour afficher des notifications à l’utilisateur.",
			...
			},
			{
				name: "CookieBanner",
				description:
					"Utilisé pour permettre à l’utilisateur d’accepter ou non les cookies.",
			...
			},
			{
				name: "HeaderLoading",
				description:
					"Utilisé pour afficher un élément de chargement avec des dimensions personnalisées.",
