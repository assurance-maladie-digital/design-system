export const locales = {
  ...
  description: 'Ce site utilise des cookies qui nous permettent de vous proposer une expérience en ligne optimale'
  + ' en enregistrant certaines informations lors de votre navigation.',
