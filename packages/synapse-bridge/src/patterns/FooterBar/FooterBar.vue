...
<template>
  ...
  >
    ...
    <VDivider v-if="extendedMode" class="mb-3" v-bind="options.divider" />
    ...
    <ul
      ...
      class="vd-footer-bar-links text-sm-center
       d-flex flex-column flex-sm-row flex-wrap
       align-start justify-center max-width-none mx-n3 my-n3"
    >
      <slot name="prepend" />
