...
export default defineComponent({
  ...
  props: {
    modelValue: {
      ...
      default: null,
      /**
       * @see https://github.com/vuetifyjs/vuetify/blob/9e4daa81bfe3046fcf7e4a731809c3d554b3df54/
       * packages/vuetify/src/components/VFileInput/VFileInput.tsx#L72C13-L72C13
       */
    ...
    <slot name="placeholder">
      <span class="vd-file-upload-placeholder">
        ...
        <span :class="colors.multiple" class="mt-1 font-weight-medium">
          <slot :multiple="multiple" name="action-text">
            {{
              multiple
