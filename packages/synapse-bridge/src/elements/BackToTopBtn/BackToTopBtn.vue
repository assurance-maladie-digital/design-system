...
export default defineComponent({
	...
	methods: {
		onScroll(e: MouseEvent): void {
			...
			this.showBtn = target === window ?
				window.scrollY > this.threshold :
					(target as HTMLElement).scrollTop > this.threshold;
		},
		...
		scrollToTop(): void {
			...
			const target = document.querySelector(this.target) || window;
