...
export const themeIcon = defineComponent({
	...
	data() {
		return {
			icons: {
				...
				arrow_down:
					'<svg fill="#0087cf" viewBox="0 0 24 24"><path d="M4.42 4.74L12 12.32l8.21-8.21L24 7.89l-12 12-12-12 3.79-3.78z"/></svg>',
				calendar:
					'<svg fill="#005da8" viewBox="0 0 24 24"><path d="M19.5 3v1.54a3 3 0 1 1-6 0V3h-3v1.54a3 3 0 1 1-6 0V3H0v21h24V3zm-12 18h-3v-3h3zm0-6h-3v-3h3zm6 6h-3v-3h3zm0-6h-3v-3h3zm3 6v-3h3zm3-6h-3v-3h3z"/><path d="M6.22 4.5v-3a1.5 1.5 0 1 1 3 0v3a1.5 1.5 0 1 1-3 0zM14.78 4.5v-3a1.5 1.5 0 1 1 3 0v3a1.5 1.5 0 0 1-3 0z"/></svg>',
				...
				helpoff:
					'<svg id="svg15" fill-rule="evenodd" clip-rule="evenodd" fill="#fff" viewBox="0 0 24 24"><circle id="circle" cx="12" cy="12" r="11.67" fill="#a4c242" stroke-width="0"/> path stroke-width="0" d="M23.35 12A11.31 11.31 0 0 0 12 .66 11.3 11.3 0 0 0 .66 12a11.31 11.31 0 0 0 19.36 8.02A11.3 11.3 0 0 0 23.35 12zm-2.86-8.49a11.96 11.96 0 0 1 0 16.98A11.97 11.97 0 0 1 0 12 11.97 11.97 0 0 1 12 0c3.31 0 6.31 1.34 8.49 3.51z"/><path d="M10.74 14.18v-.49c0-.57.1-1.04.3-1.41.21-.38.57-.77 1.09-1.17.6-.48 1-.86 1.18-1.13.18-.26.27-.58.27-.95 0-.44-.15-.77-.43-1-.3-.23-.7-.35-1.24-.35-.5 0-.95.07-1.37.21-.41.14-.82.3-1.21.5l-.65-1.36a6.8 6.8 0 0 1 3.36-.86c1 0 1.8.24 2.4.73.59.5.89 1.18.89 2.05 0 .39-.06.73-.18 1.03-.11.3-.28.59-.51.86-.23.27-.62.63-1.18 1.07-.48.37-.8.68-.97.93-.16.25-.24.58-.24 1v.34zm-.32 2.47c0-.78.38-1.17 1.14-1.17.37 0 .65.1.85.3.2.2.29.5.29.87 0 .36-.1.65-.3.86-.2.22-.48.32-.84.32-.37 0-.65-.1-.85-.3-.19-.22-.29-.5-.29-.88z"/></svg>',
				...
				warning:
					'<svg fill="#b35a00" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12"/><path fill="#fff" d="M13.19 14.12h-2.22l-.55-8.84h3.19zm-2.77 3.19c0-.55.13-.93.42-1.2.26-.25.65-.41 1.16-.41.55 0 .93.16 1.19.42.29.26.42.64.42 1.19 0 .38-.13.77-.42 1.03-.26.29-.64.42-1.19.42-.51 0-.9-.13-1.16-.42a1.36 1.36 0 0 1-.42-1.03z"/></svg>',
				separator:
					'<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#01b9f5"/></svg>',
				...
				arrow_right:
					'<svg fill="#ccc" width="24" height="24" viewBox="0 0 24 24"><path d="M10 17l5-5-5-5v10z"><path fill="#ccc" d="M0 24V0h24v24H0z"></svg>',
				arrow_drop_down:
					'<svg fill="#01b9f5" width="24" height="24" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"><path d="M0 0h24v24H0z" fill="#ccc"></svg>',
	...
	methods: {
		getThemeIcon(): any {
			if (
				this.icon !== undefined &&
				this.icons[this.icon] !== undefined
			) {
