...
export const formErrorsInvalidValues = {
  fieldNameNotExist: ['Field name does not exist'],
  questionString: 'Incorrect value',
  questionPeriod: {
    notExist: 'Sub field does not exist',
  },
  notExist: ['Field does not exist'],
} as FormErrors;
...
export const formErrors: FormErrors = {
  questionString: ['Erreur 1', 'Erreur 2'],
  questionPassword: 'Erreur',
  questionPeriod: {
    from: ['Erreur from 1', 'Erreur from 2'],
    to: ['Erreur to 1', 'Erreur to 2'],
  },
  questionChoiceButton: ['Erreur 1', 'Erreur 2'],
