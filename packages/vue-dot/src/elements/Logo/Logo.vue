<template>
	<div>
		<div v-if="headerSticky && headerScrolled">
			<svg
				:fill="fillColor"
				:aria-label="label"
				:width="dimensionsScroll.width"
				:height="dimensionsScroll.height"
				role="img"
				focusable="false"
				xmlns="http://www.w3.org/2000/svg"
				viewBox="0 0 64 64"
				:class="!secondaryLogo && !compteEntreprise ? '' : 'mr-1'"
			>
			...
			<svg
				v-if="!secondaryLogo && !compteEntreprise"
				:fill="fillColor"
				:aria-label="label"
				:height="dimensionsScroll.height"
				role="img"
...
<script lang="ts">
	...
	import { logoDimensionsScrollMapping } from './logoDimensionsScrollMapping';
	...
	export default class Logo extends MixinsDeclaration {
		...
		get dimensionsScroll(): Dimensions {
